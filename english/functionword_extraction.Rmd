...
```{r}
write_csv(all_english_tokens, "../raw_data/all_english_tokens.csv")
```
...
=======
english_tokens <- all_english_tokens # temporary line
>>>>>>> 413fa2ef32b62be3522016e231b24cc992aebf53
...
We also mark a third type, babbles 

```{r FunctionWords}
english_tokens_contract$word <- "nonfunction" # default to nonfunction word type
...
# handle babbles here
# babbles that slipped by will be given the part of speech "bab"
babbles <- c("uh", "ah", "ooh", "haha", "mm", "mmagh", "ha", "iy", "eh", "aw", "uh", "wahhh", "wahhhh", "baba", "e", "hm", "huh", "mhm","kh", "ne", "ay", "hah", "oh", "um", "va", "ew", "ih", "gh", "rh", "agh", "hah", "uhm", "oo", "heh", "wah", "uhkuh", "mmmmmmamm", "ua", "uhuh", "mmmmbghehmmbgg", "mmbmm", "ummggmm", "mmg", "mmhh", "mmmum", "mmbgeh", "mmmhm", "mmmbg", "ea", "hu", "mmmmbg", "uhoh", "baa", "la", "mmuahah", "muhooh", "uuhooah", "uheh", "gah","hagh", "mmnanananana", "unhunh", "mmbgmm", "ugh", "bowbow", "bowbowbow", "naynay", "ba", "gi", "ado", "Ada", "adaa", "doo", "lalala", "uhhuh", "ummhm", "Dwww's", "Jwww", "Jwww's", "Lala", "ee_ay", "dadadado", "mmmmg", "mmbg", "uhoh")
unintells <- c("xxx", "xx", "yyy", "www", "zzz")

bab_unint <- c(babbles, unintells)

# change the part of speech to bab
for (x in bab_unint){
  english_tokens_contract$part_of_speech[english_tokens_contract$gloss==x] <- "bab"
}

for (x in bab_unint){
  english_tokens$part_of_speech[english_tokens$gloss==x] <- "bab"
}
>>>>>>> 413fa2ef32b62be3522016e231b24cc992aebf53
```
